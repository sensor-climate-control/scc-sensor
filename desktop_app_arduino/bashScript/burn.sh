...
./arduino-cli.exe compile ./sensor_Configurer.ino -b arduino:mbed_nano:nanorp2040connect
...
./arduino-cli.exe upload ./sensor_Configurer.ino -b "arduino:mbed_nano:nanorp2040connect" -p $portnum
echo "Success!"
